...
class RemoteCompanyInfoLoaderTests: XCTestCase {
    ...
    private func expect(_ sut: RemoteCompanyInfoLoader, toCompleteWithError error: RemoteCompanyInfoLoader.Error, when action: () -> Void, file: StaticString = #file, line: UInt = #line) {
        var capturedErrors = [RemoteCompanyInfoLoader.Error]()
